...
from rnaglib.dataset_transforms import GraphRepresentation

from exp import RNATrainer

# Setup task
ta = get_task(root="roots/RNA_Ligand", task_id="rna_ligand")
...
trainer = RNATrainer(ta, model, learning_rate=1e-5, epochs=10)
